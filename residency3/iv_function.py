...
#    X['decile']=pd.qcut(X[y], 10, labels=False) ### Old     
#    X['decile']=pd.qcut(X[y], 10, labels=False, duplicates = 'drop') ### Drop 
    X['decile']=pd.qcut(X[y].rank(method='first'), 10, labels=False) ### Rank 
